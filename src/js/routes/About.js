    ...
    return (
      <AboutContainer>
        ...
        <p>
          ...
          example would be automating some flows in an application so you can
          skip the clicking around and immediately jump to where you want to be
          working.
        </p>

        <p>
          In some cases sharing these scripts would also be useful, but then
          those who are not developers would have to go through the trouble of
          learning the console, and storing the scripts I'd send them somewhere.
          That's why pocketbook was born, to quickly store or even write scripts
          in the browser and just execute them on the main page at the press of
          a button!
        </p>
        ...
        <ul>
          <li>
            Click to add a script, some defaults will be filled in for you
          </li>
          <li>
            Give your script a title, and description, and fill in the editor
